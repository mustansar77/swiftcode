        ...
        <div className="sticky py-3 pl-8 top-0 bg-white w-full">
            <nav className="flex items-center   justify-between">
                ...
                <div className="flex items-center gap-5  w-[100%] justify-end pr-3">
                    ...
                    <div className="flex gap-2 text-[14px] font-semibold font-HeadingFont "><p>English</p>
                        <Image src={DropDown} alt='' width={8.17} height={4.67} className='text-iconcolor' /></div>
                    ...
                    <div className='w-[30px] h-[30px] border-[0.1px] border-[#5c5c5c70]  p-1 rounded-full flex items-center justify-center'>
